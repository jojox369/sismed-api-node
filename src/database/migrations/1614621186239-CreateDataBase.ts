...
export class CreateDataBase1614621186239 implements MigrationInterface {
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			'CREATE TABLE `address` (`id` int NOT NULL AUTO_INCREMENT, `zip_code` varchar(10) NULL, `street` varchar(255) NULL, `number` smallint NULL, `complement` varchar(45) NULL, `neighborhood` varchar(45) NULL, `city` varchar(45) NULL, `state` varchar(2) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB'
		);
		await queryRunner.query(
